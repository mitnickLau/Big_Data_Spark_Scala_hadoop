...
public class ActiveMemberRunner extends TransformerBaseRunner {
    ...
    protected Filter fetchHbaseFilter() {
        ...
        filterList.addFilter(new SingleColumnValueFilter(ActiveMemberMapper.family, Bytes.toBytes(EventLogConstants.LOG_COLUMN_NAME_EVENT_NAME), CompareOp.EQUAL, Bytes.toBytes(EventLogConstants.EventEnum.PAGEVIEW.alias)));
