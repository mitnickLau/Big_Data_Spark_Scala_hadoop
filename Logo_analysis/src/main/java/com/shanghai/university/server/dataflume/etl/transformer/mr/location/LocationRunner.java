...
import com.shanghai.university.server.dataflume.etl.common.EventLogConstants;
...
import com.shanghai.university.server.dataflume.etl.transformer.model.value.reduce.LocationReducerOutputValue;
import com.shanghai.university.server.dataflume.etl.transformer.mr.TransformerBaseRunner;
...
public class LocationRunner extends TransformerBaseRunner {
    ...
    protected Filter fetchHbaseFilter() {
        ...
        // 过滤只需要pageview事件
        list.addFilter(new SingleColumnValueFilter(LocationMapper.family, Bytes.toBytes(EventLogConstants.LOG_COLUMN_NAME_EVENT_NAME), CompareOp.EQUAL, Bytes.toBytes(EventLogConstants.EventEnum.PAGEVIEW.alias)));
        return list;
    }
