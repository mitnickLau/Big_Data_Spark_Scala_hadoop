package com.shanghai.university.server.dataflume.etl.transformer.mr.nm;

import com.shanghai.university.server.dataflume.etl.common.DateEnum;
import com.shanghai.university.server.dataflume.etl.common.GlobalConstants;
import com.shanghai.university.server.dataflume.etl.common.KpiType;
import com.shanghai.university.server.dataflume.etl.transformer.model.dim.StatsCommonDimension;
import com.shanghai.university.server.dataflume.etl.transformer.model.dim.StatsUserDimension;
import com.shanghai.university.server.dataflume.etl.transformer.model.dim.base.BrowserDimension;
import com.shanghai.university.server.dataflume.etl.transformer.model.dim.base.DateDimension;
import com.shanghai.university.server.dataflume.etl.transformer.model.dim.base.KpiDimension;
import com.shanghai.university.server.dataflume.etl.transformer.model.dim.base.PlatformDimension;
import com.shanghai.university.server.dataflume.etl.transformer.model.value.map.TimeOutputValue;
import com.shanghai.university.server.dataflume.etl.transformer.mr.TransformerBaseMapper;
import com.shanghai.university.server.dataflume.etl.transformer.util.MemberUtil;
import com.shanghai.university.server.dataflume.etl.util.JdbcManager;
